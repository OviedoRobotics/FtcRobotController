...
public class AutonomousRedFar extends AutonomousBase {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        resetGlobalCoordinatePositionAuto(-62.8, transposeRedOrBlueY(0.0, 0.0, Alliance.RED), 0 );
...
//      unitTestOdometryDrive();
    ...
    private void mainAutonomous(BallOrder obeliskID) {
        ...
        driveToPosition(-51.8, transposeRedOrBlueY(0.0, 0.0, Alliance.RED), 0.0, DRIVE_SPEED_30, TURN_SPEED_15, DRIVE_TO);
